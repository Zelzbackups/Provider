...
pc.script.create('WelcomeHTML', function (app) {
    var WelcomeHTML = function (entity) {
        this.entity = entity;
    };
    ...
    var houses = '#buttonhouses';
    var trade = '#buttontrade';
    
    var buttons;

    WelcomeHTML.prototype = {
        initialize: function () {
            buttons = [roll, end, properties, houses, trade];
            // create DIV element
        ...
        bindEvents: function() {
            ...
            var button = this.element.querySelector('#play');
        ...
        playClick: function() {
            $(".welcome").fadeOut(400, function() {
                $("#playerNumBox").fadeIn(400);
            });
            for (i = 0; i < buttons.length; i++) {
                $(buttons[i]).css( "display", "inline-block" ).hide();
            }
        }
    };
